...
export class UserData {
  returnedData = [
    ...
    "sentiment_reasoning": "The message expresses a neutral sentiment towards the Boots Online Doctor Weight Loss Service, stating that the user is \"OK with the service at the moment.\" This suggests a neutral or ambivalent attitude, without strong positive or negative feelings expressed.",
    "most_recent_matching_message": {
        "message_id": 10370,
        ...
        "sentiment": "NEUTRAL",
        "reasoning": "The message expresses a neutral sentiment towards the Boots Online Doctor's Weight Loss service. The user states that they are \"OK with the service at the moment,\" indicating a neutral or indifferent attitude rather than a strong positive or negative sentiment."
    },
    "messages": [
        {
            "message_id": 10375,
            "content": "The online consultation offered by Boots was helpful in outlining potential weight loss solutions, but I’m taking time to review my choices.",
        ...
        {
            "message_id": 10374,
            "content": "Booking a consultation through the Boots Online Doctor Weight Loss Service was simple. I appreciated the convenience of accessing it from home.",
        ...
        {
            "message_id": 10373,
            "content": "I found the Boots Online Doctor platform to be functional and informative, though I’m still considering whether to proceed with the recommended treatment.",
        ...
        {
            "message_id": 10372,
            "content": "The service provided clear information about weight loss treatments, and I was able to complete the consultation online without any issues.",
